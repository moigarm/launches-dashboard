...
-- CreateIndex
CREATE INDEX "Launch_companyId_idx" ON "Launch"("companyId");

-- CreateIndex
CREATE INDEX "Launch_platform_idx" ON "Launch"("platform");

-- CreateIndex
CREATE INDEX "Launch_likes_idx" ON "Launch"("likes");

-- CreateIndex
CREATE UNIQUE INDEX "Launch_companyId_postId_key" ON "Launch"("companyId", "postId");
...
-- AddForeignKey
ALTER TABLE "Launch" ADD CONSTRAINT "Launch_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE CASCADE ON UPDATE CASCADE;
